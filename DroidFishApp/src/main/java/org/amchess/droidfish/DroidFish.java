...
import org.amchess.droidfish.activities.CPUWarning;
import org.amchess.droidfish.activities.EditBoard;
import org.amchess.droidfish.activities.EditOptions;
import org.amchess.droidfish.activities.EditPGNLoad;
import org.amchess.droidfish.activities.EditPGNSave;
import org.amchess.droidfish.activities.LoadFEN;
import org.amchess.droidfish.activities.LoadScid;
import org.amchess.droidfish.activities.util.PGNFile;
import org.amchess.droidfish.activities.util.PGNFile.GameInfo;
import org.amchess.droidfish.activities.Preferences;
import org.amchess.droidfish.book.BookOptions;
import org.amchess.droidfish.engine.DroidComputerPlayer.EloData;
import org.amchess.droidfish.engine.EngineUtil;
import org.amchess.droidfish.engine.UCIOptions;
import org.amchess.droidfish.gamelogic.DroidChessController;
import org.amchess.droidfish.gamelogic.ChessParseError;
import org.amchess.droidfish.gamelogic.Game;
import org.amchess.droidfish.gamelogic.Move;
import org.amchess.droidfish.gamelogic.Position;
import org.amchess.droidfish.gamelogic.TextIO;
import org.amchess.droidfish.gamelogic.GameTree.Node;
import org.amchess.droidfish.gamelogic.TimeControlData;
import org.amchess.droidfish.tb.Probe;
import org.amchess.droidfish.tb.ProbeResult;
import org.amchess.droidfish.view.MoveListView;
import org.amchess.droidfish.view.ChessBoard.SquareDecoration;
...
public class DroidFish extends Activity
...

        {
            ...
            addAction(new UIAction() {
                ...
                public void run() {
                    ...
                    if (currFT == FT_PGN) {
                        ...
                        i.setAction("org.amchess.droidfish.loadFilePrevGame");
                        i.putExtra("org.amchess.droidfish.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_SCID) {
                        i = new Intent(DroidFish.this, LoadScid.class);
                        i.setAction("org.amchess.droidfish.loadScidPrevGame");
                        i.putExtra("org.amchess.droidfish.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_FEN) {
                        i = new Intent(DroidFish.this, LoadFEN.class);
                        i.setAction("org.amchess.droidfish.loadPrevFen");
                        i.putExtra("org.amchess.droidfish.pathname", currPathName);
            ...
            addAction(new UIAction() {
                ...
                public void run() {
                    ...
                    if (currFT == FT_PGN) {
                        i = new Intent(DroidFish.this, EditPGNLoad.class);
                        i.setAction("org.amchess.droidfish.loadFileNextGame");
                        i.putExtra("org.amchess.droidfish.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_SCID) {
                        i = new Intent(DroidFish.this, LoadScid.class);
                        i.setAction("org.amchess.droidfish.loadScidNextGame");
                        i.putExtra("org.amchess.droidfish.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_FEN) {
                        i = new Intent(DroidFish.this, LoadFEN.class);
                        i.setAction("org.amchess.droidfish.loadNextFen");
                        i.putExtra("org.amchess.droidfish.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_FEN);
                    }
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case RESULT_SAVE_PGN:
            if (resultCode == RESULT_OK) {
                long hash = data.getLongExtra("org.amchess.droidfish.treeHash", -1);
        ...
        case RESULT_SELECT_SCID:
            if (resultCode == RESULT_OK) {
                ...
                if (pathName != null) {
                    ...
                    i.setAction("org.amchess.droidfish.loadScid");
                    i.putExtra("org.amchess.droidfish.pathname", pathName);
                    startActivityForResult(i, RESULT_LOAD_PGN);
                }
            }
            break;
        ...
        case RESULT_EDITOPTIONS:
            if (resultCode == RESULT_OK) {
                ...
                Map<String,String> uciOpts =
                    (Map<String,String>)data.getSerializableExtra("org.amchess.droidfish.ucioptions");
    ...
    private void shareGameOrText(boolean game) {
        ...
        if (pgn.length() < 32768) {
            ...
            String authority = "org.amchess.droidfish.fileprovider";
    ...
    private Dialog aboutDialog() {
        ...
        try {
            PackageInfo pi = getPackageManager().getPackageInfo("org.amchess.droidfish", 0);
    ...
    private void setEngineOptions() {
        ...
        UCIOptions uciOpts = ctrl.getUCIOptions();
        if (uciOpts != null) {
            i.putExtra("org.amchess.droidfish.ucioptions", uciOpts);
            i.putExtra("org.amchess.droidfish.enginename", engineTitleText.getText());
            i.putExtra("org.amchess.droidfish.workDir", engineOptions.workDir);
            boolean localEngine = engineOptions.networkID.isEmpty();
            i.putExtra("org.amchess.droidfish.localEngine", localEngine);
    ...
    private void savePGNToFile(String pathName) {
        ...
        i.setAction("org.amchess.droidfish.saveFile");
        i.putExtra("org.amchess.droidfish.pathname", pathName);
        i.putExtra("org.amchess.droidfish.pgn", pgnToken);
    ...
    private void setEditPGNBackup(Intent i, String pathName) {
        ...
        i.putExtra("org.amchess.droidfish.backup", backup);
    }
    ...
    private void loadPGNFromFile(String pathName, boolean updateCurrFile) {
        ...
        i.setAction("org.amchess.droidfish.loadFile");
        i.putExtra("org.amchess.droidfish.pathname", pathName);
        i.putExtra("org.amchess.droidfish.updateDefFilePos", updateCurrFile);
        setEditPGNBackup(i, pathName);
        startActivityForResult(i, RESULT_LOAD_PGN);
    }
    ...
    private void loadFENFromFile(String pathName) {
        ...
        i.setAction("org.amchess.droidfish.loadFen");
        i.putExtra("org.amchess.droidfish.pathname", pathName);
        startActivityForResult(i, RESULT_LOAD_FEN);
    }
