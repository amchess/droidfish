...
package org.amchess.droidfish.activities;
...
import org.amchess.droidfish.ColorTheme;
import org.amchess.droidfish.DroidFish;
import org.amchess.droidfish.DroidFishApp;
import org.amchess.droidfish.ObjectCache;
import org.amchess.droidfish.R;
import org.amchess.droidfish.Util;
import org.amchess.droidfish.activities.util.PGNFile.GameInfo;
import org.amchess.droidfish.activities.util.GameAdapter;
import org.amchess.droidfish.activities.util.PGNFile;
import org.amchess.droidfish.databinding.SelectGameBinding;
...
public abstract class EditPGN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fileName = i.getStringExtra("org.amchess.droidfish.pathname");
        backup = i.getBooleanExtra("org.amchess.droidfish.backup", false);
        updateDefaultFilePos = i.getBooleanExtra("org.amchess.droidfish.updateDefFilePos", true);
        canceled = false;
        if ("org.amchess.droidfish.loadFile".equals(action)) {
            ...
            workThread.start();
        } else if ("org.amchess.droidfish.loadFileNextGame".equals(action) ||
                   "org.amchess.droidfish.loadFilePrevGame".equals(action)) {
            pgnFile = new PGNFile(fileName);
            loadGame = true;
            boolean next = action.equals("org.amchess.droidfish.loadFileNextGame");
            workThread = new Thread(() -> {
                if (!readFile())
                    return;
            ...
            workThread.start();
        } else if ("org.amchess.droidfish.saveFile".equals(action)) {
            loadGame = false;
            String token = i.getStringExtra("org.amchess.droidfish.pgn");
    ...
    private void saveFileFinished() {
        Intent i = new Intent();
        i.putExtra("org.amchess.droidfish.treeHash", Util.stringHash(pgnToSave));
