...
public class LoadScid extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileName = i.getStringExtra("org.amchess.droidfish.pathname");
        resultSentBack = false;
        canceled = false;
        if ("org.amchess.droidfish.loadScid".equals(action)) {
        ...
        } else if ("org.amchess.droidfish.loadScidNextGame".equals(action) ||
                   "org.amchess.droidfish.loadScidPrevGame".equals(action)) {
            boolean next = action.equals("org.amchess.droidfish.loadScidNextGame");
