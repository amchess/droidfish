...
import org.amchess.droidfish.FileUtil;
import org.amchess.droidfish.R;
import org.amchess.droidfish.Util;
import org.amchess.droidfish.activities.util.FileBrowseUtil;
import org.amchess.droidfish.databinding.EditoptionsBinding;
import org.amchess.droidfish.databinding.UciOptionButtonBinding;
import org.amchess.droidfish.databinding.UciOptionCheckBinding;
import org.amchess.droidfish.databinding.UciOptionComboBinding;
import org.amchess.droidfish.databinding.UciOptionSpinBinding;
import org.amchess.droidfish.databinding.UciOptionStringBinding;
...
public class EditOptions extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        uciOpts = (UCIOptions) i.getSerializableExtra("org.amchess.droidfish.ucioptions");
        engineName = (String) i.getSerializableExtra("org.amchess.droidfish.enginename");
        workDir = (String) i.getSerializableExtra("org.amchess.droidfish.workDir");
        hasBrowser = (Boolean) i.getSerializableExtra("org.amchess.droidfish.localEngine");
        if (uciOpts != null) {
            if (hasBrowser)
    ...
    private void sendBackResult() {
        if (uciOpts != null) {
            ...
            Intent i = new Intent();
            i.putExtra("org.amchess.droidfish.ucioptions", uciMap);
