...
import org.amchess.droidfish.activities.util.FENFile;
import org.amchess.droidfish.activities.util.FENFile.FenInfo;
import org.amchess.droidfish.activities.util.FENFile.FenInfoResult;
import org.amchess.droidfish.databinding.LoadFenBinding;
...
public class LoadFEN extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ("org.amchess.droidfish.loadFen".equals(action)) {
            ...
            workThread.start();
        } else if ("org.amchess.droidfish.loadNextFen".equals(action) ||
                   "org.amchess.droidfish.loadPrevFen".equals(action)) {
            fenFile = new FENFile(fileName);
            boolean next = action.equals("org.amchess.droidfish.loadNextFen");
